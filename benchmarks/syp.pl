...
mpn_set_str($mpn1, '676469752303423489', 10, 128);
mpn_set_str($mpn2, '776469752999423489', 10, 128);
mpn_set_str($mpn_sub, '976469752313423489', 10, 128);
mpn_set_str($mpn_div, '76469752313423489', 10, 128);
mpn_set_str($mpn_ret, '0', 10, 128);
...
#    'mul_M::G1'=> '$mpz_ret = $mpz1 * $mpz2',
    ...
    'mul_M::N'=> 'mpn_mul($mpn_ret, $mpn1, $mpn2)',
});

#die "Error 1:\n$ri\n$mpz_ret\n$i_ret\n" if $ri != int128("$mpz_ret")
# || $ri != int128('525258301482620425304858018020933121') || $ri != $i_ret;

die "Error 1: $n" if ($n = mpn_get_str($mpn_ret)) ne '525258301482620425304858018020933121';
...
#    'div_M::G1'=>'$mpz_ret = $mpz1 / $mpz_div',
    ...
    'div_M::N'=> 'mpn_divrem($mpn_ret, $mpn_rem, $mpn1, $mpn_div)',
});

#die "Error 2:\n$ri\n$mpz_ret\n$i_ret\n" if $ri != int128("$mpz_ret")
# || $ri != int128('5984213521522366751') || $ri != $i_ret;

die "Error 2: $n" if ($n = mpn_get_str($mpn_ret)) ne '5984213521522366751';
...
#    'add_M::G1' => '$mpz_ret = $mpz1  + $mpz2',
    ...
    'add_M::N'  => 'mpn_add($mpn_ret, $mpn1, $mpn2)',
});

#die "Error 3:\n$ri\n$mpz_ret\n$i_ret\n" if $ri != int128("$mpz_ret") 
# || $ri != int128('1060516603104440851094132036041866242') || $ri != $i_ret;

die "Error 3: $n" if ($n = mpn_get_str($mpn_ret)) ne '1060516603104440851094132036041866242';
...
#    'sub_M::G1' => '$mpz_ret = $mpz1 - $mpz_sub',
    ...
    'sub_M::N'  => 'mpn_sub($mpn_ret, $mpn1, $mpn_sub)',
});

#die "Error 4:\n$ri\n$mpz_ret\n$i_ret\n" if $ri != int128("$mpz_ret") 
# || $ri != int128('457611325781455127825205517363509632') || $ri != $i_ret;

die "Error 4: $n" if ($n = mpn_get_str($mpn_ret)) ne '457611325781455127825205517363509632';
